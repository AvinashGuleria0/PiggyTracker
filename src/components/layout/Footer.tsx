        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-16">
          ...
          <div className="col-span-1 md:col-span-1 flex flex-col gap-4">
             ...
             <div className="flex w-full mt-2 lg:w-[250px]">
               <Input placeholder="Enter email" className="rounded-r-none border-r-0 focus-visible:ring-0 shadow-neo bg-card h-12 font-bold" />
               <Button className="rounded-l-none h-12 px-6 bg-black text-white hover:bg-neutral-800 border-l-0">Join</Button>
             </div>
             
             <div className="mt-8">
                <p className="text-sm font-black uppercase text-muted-foreground">Call Us</p>
                <p className="font-black text-xl text-foreground">(239) 555-0108</p>
             </div>
             <div className="mt-2">
                <p className="text-sm font-black uppercase text-muted-foreground">Email Us</p>
                <p className="font-black text-lg text-foreground">info@piggytracker.xyz</p>
             </div>
          </div>
        </div>
        
        <div className="border-t-2 border-border pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="font-bold text-muted-foreground text-sm">© Copyright 2026, All Rights Reserved</p>
